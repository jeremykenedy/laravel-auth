            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @endif
                    @endif
                    <a href="{{ url('/terms') }}" class="text-sm text-gray-500 underline" style="margin-left: 5px;">Terms</a>
                </div>
            @endif

            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <a href="https://github.com/jeremykenedy/laravel-auth" target="_blank">
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://github.com/sponsors/jeremykenedy" class="ml-1 underline">
                                Sponsor
                            </a>
                        </div>
                    </div>
