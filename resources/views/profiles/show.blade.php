					...
					<div class="panel-body">
						...
						@if ($user->profile)
							@if (Auth::user()->id == $user->id)
								...
								{!! HTML::icon_link(URL::to('/profile/'.Auth::user()->name.'/edit'), 'fa fa-fw fa-cog', Lang::get('titles.editProfile'), array('class' => 'btn btn-small btn-info btn-raised btn-block')) !!}

							@endif
						@else

							<p>{{ Lang::get('profile.noProfileYet') }}</p>
							{!! HTML::icon_link(URL::to('/profile/'.Auth::user()->name.'/edit'), 'fa fa-fw fa-plus ', Lang::get('titles.createProfile'), array('class' => 'btn btn-small btn-info btn-raised btn-block')) !!}
